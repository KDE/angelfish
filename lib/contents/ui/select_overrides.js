// taken from morph browser (UBPorts)
...
(function() {
    ...
    function handleSelect(select) {
        ...
        var index = window.prompt("XX-ANGELFISH-SELECT-OVERRIDE-XX",JSON.stringify({selectedIndex: select.selectedIndex, options: opts}));
        if (index !== null)  {
